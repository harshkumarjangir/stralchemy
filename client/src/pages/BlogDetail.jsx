...
const BlogDetail = () => {
  ...
  const cleanContent = blog && blog.content ? blog.content.replace(/&nbsp;|\u00a0/g, ' ') : '';
    ...
    <div className="bg-[#f8f9fa] min-h-screen pb-24">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 -mt-10 relative z-10">
        <div className="bg-white p-8 md:p-16 shadow-lg rounded-t-lg border border-gray-100">
          ...
          <div 
            className="prose-custom text-gray-700 leading-relaxed space-y-6 wrap-break-word break-words w-full overflow-hidden
              ...
              [&>p]:mb-6 [&>p]:text-[1.05rem] [&>p>strong]:text-gray-900 [&>p]:whitespace-normal [&>p]:max-w-full
