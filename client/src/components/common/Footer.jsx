...
const Footer = () => {
  return (
    <footer className="bg-white text-gray-800 pt-16 pb-0 relative border-t border-gray-100">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-10 pb-12">
        ...
        <div className="col-span-1">
          ...
          <div className="flex space-x-4">
            <a href="https://www.instagram.com/stralchemy/" target="_blank" rel="noreferrer" className="bg-gray-100 text-brand-purple p-2 rounded-full hover:bg-brand-purple hover:text-white transition-colors w-10 h-10 flex items-center justify-center font-bold text-xs" aria-label="Instagram">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
            </a>
            <a href="https://www.linkedin.com/company/stralchemy" target="_blank" rel="noreferrer" className="bg-gray-100 text-brand-purple p-2 rounded-full hover:bg-brand-purple hover:text-white transition-colors w-10 h-10 flex items-center justify-center font-bold text-xs" aria-label="LinkedIn">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
            </a>
            <a href="https://www.facebook.com/stralchemy/" target="_blank" rel="noreferrer" className="bg-gray-100 text-brand-purple p-2 rounded-full hover:bg-brand-purple hover:text-white transition-colors w-10 h-10 flex items-center justify-center font-bold text-xs" aria-label="Facebook">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
            </a>
            <a href="https://www.youtube.com/@Stralchemy" target="_blank" rel="noreferrer" className="bg-gray-100 text-brand-purple p-2 rounded-full hover:bg-brand-purple hover:text-white transition-colors w-10 h-10 flex items-center justify-center font-bold text-xs" aria-label="YouTube">
      ...
      <a href="https://wa.me/918943408857" target="_blank" rel="noreferrer" className="fixed bottom-20 right-8 bg-[#25D366] p-4 rounded-full text-white shadow-lg hover:bg-[#128C7E] transition-colors z-50 flex items-center justify-center" aria-label="WhatsApp">
