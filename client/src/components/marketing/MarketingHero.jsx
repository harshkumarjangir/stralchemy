...
const MarketingHero = () => {
  return (
    <section className="bg-gray-900 text-white py-32 md:py-48 px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-brand-green rounded-full blur-[150px] opacity-20 pointer-events-none -translate-y-1/2 translate-x-1/3"></div>
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-teal-500 rounded-full blur-[120px] opacity-20 pointer-events-none translate-y-1/2 -translate-x-1/3"></div>
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold mb-8 leading-tight tracking-tighter">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-green via-teal-400 to-brand-green animate-gradient-x">
            Drives Results
          </span>
        </h1>
